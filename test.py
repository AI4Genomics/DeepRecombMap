...
recomb_dataset_test = RecombDataset(path='./data/', f5name='sample_dataset.h5', split='test')
print("The number of samples in {} split is {}.".format('test', len(recomb_dataset_test)))
print("The first 10 ids of test samples are:\n  {}\n".format("\n  ".join(recomb_dataset_test.ids[:10])))